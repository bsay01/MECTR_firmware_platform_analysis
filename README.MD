...
![An image of testing setup showing four Pico 1 microprocessors wired to a fifth Pico for timing the tests.](https://github.com/bsay01/ENGR446_code/blob/main/setup-small.JPG?raw=true)
